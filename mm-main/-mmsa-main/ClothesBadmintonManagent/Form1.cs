...
namespace ClothesBadmintonManagent
{
    ...
    {
        string connectionString = @"Data Source=Truong_Ngoc_Hoa;Initial Catalog=Highs;Integrated Security=True;TrustServerCertificate=True";
        SqlConnection con;
        //SqlCommand cmd;
        SqlDataAdapter adt;
        ...
        private void btn_login_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    // Check if admin login is used (priority check)
